...
const RoomController = () => {
	...
	useEffect(() => {
		const checkAuthorization = async () => {
			...
			// Check if guest has filled in their name
			...
			// Not authorized - redirect to guest welcome
		...
		return (
			<div className="controller-page">
				<div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: '100vh', gap: '16px' }}>
					...
					<p style={{ color: 'rgba(148, 163, 184, 0.6)', fontSize: '0.9rem' }}>Redirecting...</p>
				</div>
			</div>
		);
	}
	...
	return (
		<div className="controller-shell controller-page">			<div className="controller-top-grid">
				<div className="controller-info-card">
					...
					<div className="controller-info-meta">
						<div className="controller-meta-item">
							...
							<span className="controller-meta-text">{userName}</span>
						</div>
						<div className="controller-meta-item">
							<span className="controller-meta-icon">#</span>
				...
				<div className="controller-interactive-card">
					{isAuthenticated && (
						<button
							className="interactive-settings-btn"
							aria-label="Room settings"
							onClick={() => navigate(`/rooms/${roomKey}`)}
						>
